...
/** In-page section ids used by the navbar (fixed header offset via Tailwind scroll-mt). */
const SECTION_IDS = new Set(['about', 'skills', 'projects', 'clients', 'blog', 'contact'])

// Navbar Component
function Navbar({ onNavigateToSection }: { onNavigateToSection: (href: string) => void }) {
    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        >
          {isScrolled ? (
            <>
              <span className="text-primary-500">Sakshi</span>
              <span className="text-gray-900">Bagora</span>
            </>
          ) : (
            <>
              <span className="text-gray-900">Sakshi</span>
              <span className="text-primary-500">Bagora</span>
            </>
          )}
        </a>
        ...
        <button type="button" className="md:hidden p-2" onClick={() => setMobileMenuOpen(!mobileMenuOpen)} aria-label="Toggle menu">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-32 pb-12 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.2 }}>
            <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }} className="text-primary-500 font-semibold mb-4 tracking-[0.2em] uppercase text-sm">
              Email Marketing Specialist
            </motion.p>
            <h1 className="mb-6 leading-[1.05]">
              <span className="block text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900">Hi, I&apos;m</span>
              <span className="mt-2 block text-5xl sm:text-6xl lg:text-7xl font-extrabold text-primary-500">
                Sakshi Bagora
              </span>
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              <a href="#contact" className="inline-flex items-center gap-2 bg-primary-500 text-white px-8 py-4 rounded-full font-semibold hover:bg-primary-600 transition-all duration-300 hover:shadow-lg hover:shadow-orange-200/80">
                Get In Touch <ArrowRight size={20} aria-hidden />
              </a>
              <a href="#projects" className="inline-flex items-center gap-2 bg-white border-2 border-gray-200 text-gray-800 px-8 py-4 rounded-full font-semibold hover:border-primary-400 hover:text-primary-600 transition-all duration-300 shadow-sm">
                View Work
              </a>
            </div>
          </motion.div>
        ...
        <div className="mt-16 lg:mt-20 pt-10 border-t border-gray-200/90">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 text-center sm:text-left max-w-4xl mx-auto lg:max-w-none">
            <div>
              <p className="text-4xl sm:text-5xl font-bold text-primary-500 tabular-nums">3+</p>
              <p className="text-gray-600 text-sm sm:text-base mt-1 font-medium">Years Experience</p>
            </div>
            <div>
              <p className="text-4xl sm:text-5xl font-bold text-primary-500 tabular-nums">34+</p>
              <p className="text-gray-600 text-sm sm:text-base mt-1 font-medium">Enterprise Clients</p>
            </div>
            <div>
              <p className="text-4xl sm:text-5xl font-bold text-primary-500 tabular-nums">500K+</p>
              <p className="text-gray-600 text-sm sm:text-base mt-1 font-medium">Subscribers Managed</p>
            </div>
          </div>
        </div>

        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.5 }} className="mt-12 flex justify-center pb-6">
...
function Skills() {
  return (
    <section id="skills" className="scroll-mt-24 py-24 bg-gradient-to-br from-gray-50 to-orange-50">
      <div className="max-w-7xl mx-auto px-6">
        <AnimatedSection>
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
...
function Clients() {
  return (
    <section
      id="clients"
      className="scroll-mt-24 py-24 overflow-hidden bg-gradient-to-b from-gray-50 via-white to-orange-50/30"
    >
      <div className="max-w-7xl mx-auto px-6 mb-16">
        <AnimatedSection>
          <div className="text-center">
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
              Brands I&apos;ve <span className="text-primary-500">Worked With</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Trusted by leading brands across diverse industries
            </p>
            <div className="w-24 h-1 bg-gradient-to-r from-primary-500 to-orange-400 mx-auto mt-6 rounded-full" />
          </div>
        </AnimatedSection>
      </div>

      <div className="relative">
        <div className="pointer-events-none absolute left-0 top-0 bottom-0 w-24 sm:w-32 bg-gradient-to-r from-gray-50 to-transparent z-10" />
        <div className="pointer-events-none absolute right-0 top-0 bottom-0 w-24 sm:w-32 bg-gradient-to-l from-orange-50/50 to-transparent z-10" />
        ...
        <div className="flex animate-marquee">
          {[...clients, ...clients].map((client, index) => (
            <a
              ...
              className="flex-shrink-0 mx-4 sm:mx-6 opacity-95 hover:opacity-100 transition-opacity duration-300"
            >
              <div className="flex items-center justify-center h-[5.5rem] min-w-[10rem] sm:min-w-[11rem] rounded-2xl bg-white px-5 py-4 shadow-md shadow-gray-200/80 border border-gray-100 hover:border-primary-200 hover:shadow-lg hover:shadow-orange-100/60 transition-all duration-300">
                {client.logo ? (
                  <img
                    src={client.logo}
                    alt={client.name}
                    className="h-12 sm:h-14 w-auto max-w-[9rem] sm:max-w-[10rem] object-contain object-center"
                  />
                ) : (
                  <span className="text-gray-700 text-sm font-semibold text-center leading-snug px-1">
                    {client.name}
                  </span>
                )}
              </div>
...
function Blog({ onPostClick }: { onPostClick: (post: typeof blogPosts[0]) => void }) {
  return (
    <section id="blog" className="scroll-mt-24 py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        <AnimatedSection>
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
...
// Footer
function Footer({ onNavigateToSection }: { onNavigateToSection: (href: string) => void }) {
  const footerLinks = {
            ...
            <div key={title}>
              ...
              <ul className="space-y-2">
                {links.map((link) => {
                  ...
                  const href = `#${slug}`
                  const isSectionLink = title === 'Quick Links' && SECTION_IDS.has(slug)
                  return (
                    <li key={link}>
                      <a
...
function App() {
  ...
  const navigateToSection = useCallback((href: string) => {
    if (href === '#' || href === '') {
      if (selectedPost) flushSync(() => setSelectedPost(null))
    ...
    if (selectedPost) {
      flushSync(() => setSelectedPost(null))
    }
  ...
  const handleBlogBack = useCallback(() => {
  ...
  if (selectedPost) {
    return (
      <div>
        <Navbar onNavigateToSection={navigateToSection} />
        <BlogPost post={selectedPost} onBack={handleBlogBack} />
